...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        with warnings.catch_warnings():  # suppress DecompressionBombWarning
            ...
            self.__image = ImageOps.exif_transpose(Image.open(self.path)) if isinstance(self.path, str) else ImageOps.exif_transpose(self.path)  # open image, but down't load it
        ...
        self.__pyramid = [self.smaller()] if self.__huge else [Image.open(self.path) if isinstance(self.path, str) else self.path]
